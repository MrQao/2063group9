...
public class ObjectFactory {
    ...
    private final static QName _IOException_QNAME = new QName("http://model/", "IOException");
    private final static QName _JAXBException_QNAME = new QName("http://model/", "JAXBException");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://model/", name = "IOException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://model/", name = "JAXBException")
